...
genome=/NABIC/HOME/yedomon1/genomeassemblyfungiMR004/02.Canu_assembly/MR4003_pilon_3.fasta
...
for fq_trim1 in $trimmed_reads_path/*_1.trim.fastq.gz
    ...
    do
         ...
         echo "base name is $base"
                ...
                sam=$polishing_path/sam/${base}.round4.aligned.sam 
                bam=$polishing_path/bam/${base}.round4.aligned.bam
                sorted_bam=$polishing_path/bam/${base}.round4.aligned.sorted.bam
                 ...
                 samtools sort $bam ${base}.round4.aligned.sorted            
                 ...
                 java -Xmx16G -jar \
                       ...
                       --genome $genome --frags $sorted_bam --output MR4003_pilon_4 \
