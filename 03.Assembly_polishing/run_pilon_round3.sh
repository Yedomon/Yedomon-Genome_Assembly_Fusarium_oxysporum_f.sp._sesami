...
genome=/NABIC/HOME/yedomon1/genomeassemblyfungiMR004/02.Canu_assembly/MR4003_pilon_2.fasta
...
for fq_trim1 in $trimmed_reads_path/*_1.trim.fastq.gz
    ...
    do
         ...
         echo "base name is $base"
                ...
                sam=$polishing_path/sam/${base}.round3.aligned.sam 
                bam=$polishing_path/bam/${base}.round3.aligned.bam
                sorted_bam=$polishing_path/bam/${base}.round3.aligned.sorted.bam
                 ...
                 samtools sort $bam ${base}.round3.aligned.sorted
                 ...
                 --genome $genome --frags $sorted_bam --output MR4003_pilon_3 \
